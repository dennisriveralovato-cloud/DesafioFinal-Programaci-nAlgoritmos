...
namespace BibliotecaUniversitaria
{
    ...
    class Program
    {
        ...
        static int[,] matrizReportes = new int[3, 3];
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("3. Gestión de Prestamos");
        ...
        static void RegistrarLibro()
        {
            ...
            {
                Console.WriteLine("No hay espacio para mas libros");
                return;
            }
            ...
            do
            {
                Console.Write("Codigo del libro (8 caracteres): ");
        ...
        {
            Console.Clear();
            Console.Write("Ingrese codigo del libro a eliminar: ");
            string codigo = Console.ReadLine();
        ...
        static void RegistrarUsuario()
        {
            ...
            {
                Console.WriteLine("No hay espacio para mas usuarios");
                return;
            }
            ...
            do
            {
                Console.Write("Carnet (8 digitos): ");
        ...
        {
            Console.Clear();
            Console.Write("Ingrese carnet o nombre: ");
        ...
        static void RegistrarPrestamo()
        {
            ...
            } while (nuevo.carneUsuario.Length != 8 || !long.TryParse(nuevo.carneUsuario, out _));
            ...
            } while (nuevo.codigoLibro.Length != 8 || !nuevo.codigoLibro.StartsWith("LIB"));
            ...
            } while (nuevo.fechaPrestamo.Length != 10 || nuevo.fechaPrestamo[2] != '/' || nuevo.fechaPrestamo[5] != '/');
            ...
            } while (nuevo.fechaDevolucion.Length != 10 || nuevo.fechaDevolucion[2] != '/' || nuevo.fechaDevolucion[5] != '/');
        ...
        static void MostrarPrestamos()
        {
            ...
            for (int i = 0; i < contadorPrestamos; i++)
            {
                ...
                Console.WriteLine("Fecha prestamo: " + prestamos[i].fechaPrestamo);
                Console.WriteLine("Fecha devolucion: " + prestamos[i].fechaDevolucion);
        ...
        static void MenuReportes()
        {
            ...
            matrizReportes[0, 0] = contadorLibros;
            matrizReportes[1, 1] = contadorUsuarios;
            matrizReportes[2, 2] = contadorPrestamos;

            Console.WriteLine("===== REPORTES =====");
            Console.WriteLine("Total libros: " + matrizReportes[0, 0]);
            Console.WriteLine("Total usuarios: " + matrizReportes[1, 1]);
            Console.WriteLine("Total prestamos: " + matrizReportes[2, 2]);
        ...
        static void ExportarReporte()
        {
            ...
            writer.WriteLine("Libros registrados: " + contadorLibros);
            writer.WriteLine("Usuarios registrados: " + contadorUsuarios);
            writer.WriteLine("Prestamos registrados: " + contadorPrestamos);
        ...
        static void GuardarLibros()
        {
            ...
            for (int i = 0; i < contadorLibros; i++)
            {
                writer.WriteLine(libros[i].codigo + "," +
                                 libros[i].titulo + "," +
                                 libros[i].autor + "," +
                                 libros[i].editorial + "," +
                                 libros[i].anio + "," +
        ...
        static void GuardarUsuarios()
        {
            ...
            for (int i = 0; i < contadorUsuarios; i++)
            {
                writer.WriteLine(usuarios[i].carne + ";" +
                                 usuarios[i].nombre + ";" +
                                 usuarios[i].carrera + ";" +
                                 usuarios[i].correo + ";" +
                                 usuarios[i].telefono + ";" +
        ...
        static void GuardarPrestamos()
        {
            ...
            for (int i = 0; i < contadorPrestamos; i++)
            {
                writer.WriteLine(prestamos[i].carneUsuario + ";" +
